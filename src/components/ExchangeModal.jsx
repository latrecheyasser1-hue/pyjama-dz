  ...
  return (
    ...
    >
      ...
      >
        ...
        {!hasAccount ? (
          /* VIP Member-only Gatekeeper Screen */
          <div style={{ textAlign: 'center', padding: '28px 12px 16px' }}>
            <div style={{
              ...
              justifyContent: 'center',
              margin: '0 auto 18px',
              boxShadow: '0 8px 24px rgba(190, 18, 60, 0.15)'
            }}>
              <Lock size={36} color="var(--burgundy)" />
            </div>
            ...
            <span style={{
              ...
              🔒 خدمة خاصة بالزبائن المسجلين بحساب فقط
            </span>

            <h3 style={{ fontSize: '1.35rem', fontWeight: 900, color: '#1E293B', margin: '0 0 10px' }}>
              طلب الاستبدال (Échange) متاح فقط لأصحاب الحسابات
            </h3>

            <p style={{ fontSize: '0.92rem', color: '#475569', lineHeight: 1.7, maxWidth: '440px', margin: '0 auto 22px' }}>
              عزيزي(تي) الزبون(ة)، خدمة استبدال المقاس أو الموديل مخصصة <strong>حصرياً للزبائن الذين لديهم حساب مفتوح في المتجر</strong>، وذلك لحفظ بيانات طلبياتك ومتابعة فارق السعر ومستحقاتك بكل أمان.
            </p>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.86rem', color: '#334155', fontWeight: 700 }}>
                ...
                <span>ربط فوري وموثوق بين طلبيتك ورقم هاتفك المسجل</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.86rem', color: '#334155', fontWeight: 700 }}>
                <Check size={18} color="#16A34A" />
                <span>ضمان أمان تحويلات فارق السعر عبر BaridiMob RIP</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.86rem', color: '#334155', fontWeight: 700 }}>
                <Check size={18} color="#16A34A" />
                <span>فتح الحساب مجاني وسريع في أقل من 30 ثانية برقم هاتفك</span>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <button
                ...
                style={{
                  background: 'linear-gradient(135deg, #6B1D2F 0%, #8B253E 100%)',
                  color: '#FFF',
                  border: 'none',
                  borderRadius: '14px',
                  padding: '14px 24px',
                  ...
                  justifyContent: 'center',
                  gap: '8px',
                  boxShadow: '0 8px 18px rgba(107, 29, 47, 0.25)'
                }}
              >
                <UserCheck size={20} />
                <span>تسجيل الدخول / فتح حساب الآن</span>
              </button>
