...
export default function Storefront({ products, orders = [], settings, onPlaceOrder, onUpdateSettings, onGoToGros }) {
  ...
  const handleWaitlistSubmit = async (e) => {
    ...
    try {
      ...
      const SUPABASE_URL = 'https://lrepmdrzpgvctssywjsn.supabase.co';
      const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxyZXBtZHJ6cGd2Y3Rzc3l3anNuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODc1OTE4OTAsImV4cCI6MjEwMzE2Nzg5MH0.lzHxSmKiVHytt8-Rvr0uKEbtYVb0rylGcnViiXSFQjc';
