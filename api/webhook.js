...
إذا كان الصوت فارغاً أو غير مفهوم، أخرج كلمة واحدة فقط: "غير_مفهوم". لا تطلب من الزبون أبداً أن يكتب.
أخرج الكلمات التي نطقها الزبون حرفياً فقط.`;
                    const systemInstruction = "أنت أداة تفريغ صوتي (Speech-to-Text) جزائرية. أخرج النص المسموع حرفياً فقط. لا تطلب من المستخدم الكتابة أبداً.";
